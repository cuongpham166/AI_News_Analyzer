package com.example.news.api.repository.sync;

import com.example.news.api.util.query.graph.GraphDataQuery;
...
@Repository
public class SyncGraphDataRepository {
    private final Neo4jClient neo4jClient;
    private final GraphDataQuery graphDataQuery;

    public SyncGraphDataRepository(
