...
import type { ImpactNews } from '@/shared/interfaces/ImpactNews.ts';
import { fetchImpactNews } from '@/services/analysisService.ts';

import { getColorCode } from '@/shared/utils/getColorCode.ts';
import { SentimentColors, ThemeColors } from '@/shared/constants/Colors.ts';
